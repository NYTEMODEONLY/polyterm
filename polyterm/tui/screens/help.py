...
def help_screen(console: RichConsole):
    ...
    shortcuts.add_row("hist", "History - CLOB price history (refuses if unavailable)")
    ...
    shortcuts.add_row("bt", "Backtest - DEMO simulation (not historical)")
    ...
    features.add_row("🐋", "[bold]Whales:[/bold] 24h volume heuristic, or --wallets for trader identity")
    ...
    features.add_row("📜", "[bold]History:[/bold] CLOB /prices-history (refuses instead of inventing a path)")
    ...
    features.add_row("📈", "[bold]Backtest:[/bold] DEMO random simulation (not historical replay)")
    ...
    features.add_row("🏆", "[bold]Leaderboard:[/bold] Public Data API PNL/volume rankings")
    ...
    console.print("[dim]  polyterm whales --wallets      # Wallet-level whale trades[/dim]")
    ...
    console.print("[dim]  polyterm history bitcoin       # CLOB price history[/dim]")
    ...
    console.print("[dim]  polyterm backtest --demo -s momentum # DEMO simulation[/dim]")
